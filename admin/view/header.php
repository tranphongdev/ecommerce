...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Ông ơi cái đơn hàng này...</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Allooo, h ông rảnh k</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Tiếng Trước</p>
              </div>
            </div>
            <!-- Message End -->
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Check tin nhắn tôi nhờ....</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Tiếng Trước</p>
              </div>
            </div>
            <!-- Message End -->
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item dropdown-footer">Hiển Thị Tất Cả</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> 3 tố cáo
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin - PShop</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/avt-ps.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <?php
              if(isset($_SESSION['login'])){
                echo '<a href="index.php?page=profile" class="d-block">'.$_SESSION['login'][2].'</a>'; 
              }
          ?>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?page=addproducts" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?page=addusers" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
